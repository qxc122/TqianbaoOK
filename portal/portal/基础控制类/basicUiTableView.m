...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(NETWORK_FROM_CONNECTION_TO_CONNECTION_NOTIFICATIONFunC:)
...
//            [weakself postNETWORK_FROM_CONNECTION_TO_CONNECTION_NOTIFICATION];
//        }else{
