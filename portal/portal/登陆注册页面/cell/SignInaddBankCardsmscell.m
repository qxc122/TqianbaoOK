...
@implementation SignInaddBankCardsmscell
+ (instancetype)returnCellWith:(UITableView *)tableView
{
    SignInaddBankCardsmscell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([self class])];
    if (cell == nil) {
