//
//  ConfirmapayTypeSeleMoneyCell.m
//  portal
//
...
@implementation ConfirmapayTypeSeleMoneyCell

+ (instancetype)returnCellWith:(UITableView *)tableView
{
    ConfirmapayTypeSeleMoneyCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([self class])];
    if (cell == nil) {
