...
-(void)createScrollView{
    ...
    page = [[KTPageControl alloc] initWithFrame:CGRectMake(0, kScreen_height - 20-15, kScreen_width, 15)];
...
-(void)enterBtnClick{
    [self hideGuidView];
    NSNotification *notification =[NSNotification notificationWithName:@"moneyyyyyy" object:nil userInfo:nil];
