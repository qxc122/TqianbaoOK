...
@implementation ReaNameaddBankCardsmscell
+ (instancetype)returnCellWith:(UITableView *)tableView
{
    ReaNameaddBankCardsmscell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([self class])];
    if (cell == nil) {
