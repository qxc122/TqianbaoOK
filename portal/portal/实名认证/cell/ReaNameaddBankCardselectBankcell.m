//
//  ReaNameaddBankCardselectBankcell.m
//  portal
//
...
@implementation ReaNameaddBankCardselectBankcell
+ (instancetype)returnCellWith:(UITableView *)tableView
{
    ReaNameaddBankCardselectBankcell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([self class])];
    if (cell == nil) {
